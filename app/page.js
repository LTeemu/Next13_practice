        ...
        <div className='flex flex-col w-full h-full px-8 border-b border-stone-700 sm:flex-row'>
          <div className='flex items-center justify-center flex-1 order-2 sm:order-1'>
            <div className='flex flex-col'>
              <h1 className='text-3xl font-semibold text-white'>Organic plantbased<br /> potato milk is here!</h1>
              <button className='px-3 py-1 mt-6 mb-2 text-xl text-white border-4 border-gray-400 rounded-full font-base bg-stone-900 w-max'>Press button</button>
            </div>
          </div>
